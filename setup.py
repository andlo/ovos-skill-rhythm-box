...
URL = "https://github.com/andlo/ovos-skill-rhythm-box"
SKILL_CLAZZ = "RhythmBox"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-rhythm-box"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="A simple drum-machine/rhythm-box skill for OVOS - loop a basic beat pattern (rock, four-on-the-floor, etc) at a chosen tempo, using short bundled percussion samples. More involved than the metronome: ",
    ...
    keywords="ovos skill voice assistant music drums rhythm beat",
